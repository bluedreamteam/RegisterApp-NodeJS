...
import { PageResponse, CommandResponse,
	// ActiveUser,
MainMenuPageResponse } from "./typeDefinitions";

export const start = async (req: Request, res: Response): Promise<void> => {// if (Helper.handleInvalidSession(req, res))
	// {
	// 	return;
	// }
